...
exports.doesBranchExists = exports.validateIsInsideGitProject = exports.addToGit = exports.getDiffs = exports.getBranchName = void 0;
...
const getBranchName = async () => {
    ...
    (0, logger_js_1.log)(`GIT: Branch: ${currentBranchName}`);
...
exports.validateIsInsideGitProject = validateIsInsideGitProject;
const doesBranchExists = async (branchName) => {
    return exec(`git rev-parse --verify ${branchName}`)
        .then(() => true)
        .catch(() => false);
};
exports.doesBranchExists = doesBranchExists;
